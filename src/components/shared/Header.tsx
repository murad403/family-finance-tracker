...
import { AlertTriangle, Bell, CheckCircle2, ChevronDown, Info, LogOut, Menu, Search, Settings } from 'lucide-react';
...
const Header = ({ onMenuClick }: HeaderProps) => {
    ...
    const { logout, notifications, markNotificationAsRead, markAllNotificationsAsRead, settings, members, expenses, incomes } = useFinance();
